...
\newcommand{\aboutMeEntryTSDL}[3]{
  \vspace{-1pt}\item[]
	...
	% \begin{tabular*}{0.97\textwidth}{l@{\extracolsep{0pt}}lrlr}
	  ...
	  \color{primary}{Languages} & \textit{\color{accent}#3} & & \\
    \end{tabular*}\vspace{-6pt}
}
...
\section{}{About me}
	%\resumeEntryStart
	%	\resumeEntryS{Full name } {Reza Sameei Golvajh}
	%	\resumeEntryS{Date of Birth} {Nov 1988}
	%	\resumeEntryS{Mobile} {(+98) 912 666 2695}
	%	\resumeEntryS{Languages} {English / B2 ; Persian / Native}
	%\resumeEntryEnd
	
    \resumeEntryStart
      \aboutMeEntryTSDL
	  	{Reza Sameei Golvajh}{Nov 1988}{English(B2), Persian(Native)}
    \resumeEntryEnd
	\vspace{-4pt} % Set a negative value to push the body up, and the opposite
