...
\section{\faPieChart}{Experience}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{Design for maximum flexibility to reduce the risk caused by \textit{not having adequate context of domain}, while being effective to reduce the complexity of the overall design as a \textbf{member of architect board}}
...
\section{\faGears}{Open Source Projects}
	\resumeEntryStart
		\resumeEntryS{\href{https://github.com/sameei/elasticreporter}{ElasticReporter}} {to push Apache Flink monitoring stats to Elastic directly; Support only Flink 1.2, 1.3, 1.5}
		\resumeEntryS{\href{https://github.com/sameei/SARF}{SARF}} {Simple Abstraction for Remote Function, a toolkit providing the ground for RPC based communication}
	\resumeEntryEnd
