...
\section{\faPieChart}{Experience}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{Design for maximum flexibility to reduce the risk caused by not having adequate context of domain, while being effective to reduce the complexity of the overall design as a \textbf{member of architecture board}}
